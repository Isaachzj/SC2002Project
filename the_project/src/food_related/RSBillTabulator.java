...
public class RSBillTabulator {
	 ...
	 * the RoomService object includes the list of food items ordered and its price, which is required for this method to calculate the total bill of the RoomService
	 */
