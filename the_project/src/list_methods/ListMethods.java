 ...
 * Many smaller interface; inwhich this case is an extension of Add, Remove, Get, Set, Print and Reset class
 * Add allows an object to be added to the entry using AddStandard and AddGivenObject class
 * Remove allows an object to be removed from the entry using RemoveStandard and RemoveGivenObject class
