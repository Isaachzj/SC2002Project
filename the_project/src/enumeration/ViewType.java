...
public enum ViewType {
	 ...
	 * the guest can view the shallow turquoise ocean that invites the
	 * fresh smell of sea salt upon the opening of the window;
	 */
	OCEAN, 
	/**
	 * viewType of RoomFeatures object is City;
	 * type of view for DeluxeRoom object;
	 * the guest can view the city bustling with full of life as
	 * there are indistinguishable chatter among the street vendors;
	 */
	CITY
}
