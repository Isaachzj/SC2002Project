...
public class CreditCardInfoManipulator {
	...
	/**
	 * Updates the credit card information of the guest; with the input of the guest's credit details 
	 ...
	 * Else, if Guest object found; its credit card information (CreditCardInfo Object) would be updated 
	 * accordingly
